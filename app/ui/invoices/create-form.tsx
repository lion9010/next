    ...
    <form action={formAction} ref={formRef}>
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              id="customer"
              name="customerId"
              className="peer block w-full cursor-pointer rounded-md border border-(--border) py-2 pl-10 text-sm placeholder:text-(--primary-30) bg-(--background) text-(--foreground)"
              defaultValue=""
              required
            ...
            <UserCircleIcon
              aria-hidden="true"
              className="pointer-events-none absolute left-3 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-(--primary-30)"
            />
          </div>
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                className="peer block w-full rounded-md border border-(--border) py-2 pl-10 text-sm placeholder:text-(--primary-30) bg-(--background)"
              />
              <CurrencyDollarIcon
                aria-hidden="true"
                className="pointer-events-none absolute left-3 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-(--primary-30) peer-focus:text-(--primary)"
              />
            </div>
          </div>
          <div id="customer-error" aria-live="polite" aria-atomic="true">
      ...
      <div className="mt-6 flex justify-end gap-4">
        <Link
          ...
          className="flex h-10 items-center rounded-lg bg-(--muted) px-4 text-sm font-medium text-(--muted-foreground) transition-colors hover:bg-(--primary-30)"
        >
          Cancel
        </Link>
        <Button
