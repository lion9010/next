    ...
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      ...
      <div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
        ...
        <div className="hidden h-auto w-full grow rounded-md bg-(--background) md:block"></div>
          ...
          <button onClick={() => signOut()} className="flex h-12 w-full grow items-center justify-center gap-2 rounded-md bg-(--background) p-3 text-sm font-medium hover:bg-(--destructive-background) hover:text-(--destructive) md:flex-none md:justify-start md:p-2 md:px-3">
